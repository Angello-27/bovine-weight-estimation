...
import WeightEstimationTemplate from '../templates/WeightEstimationTemplate';
...
function WeightEstimationsView() {
    ...
    return (
        <PanelTemplate content={<WeightEstimationTemplate {...estimationsProps} onViewClick={handleViewClick} onEstimateClick={handleEstimateClick} />} />
    );
}
